...
def parse_file( fname, edges, polygons, transform, csystems, screen, color ):
    ...
    while c < len(lines):
        ...
        #elif line == 'apply':
        #    systems_matrix_mult( transform, edges )
        #    systems_matrix_mult( transform, polygons )
            ...
            first = [row[:] for row in csystems[-1]]
            csystems.append(first)
